...
func TestStatusPageRoutes_ServesHTML(t *testing.T) {
	...
	// Shared template: nav bar with wordmark SVG + status label
	if !strings.Contains(body, `viewBox="0 0 1020 350"`) {
		t.Error("status page missing wordmark SVG in nav bar")
	}
